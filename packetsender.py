...
class UDPHandler:
    ...
    def send_packet(self, packet, resend=1):
    ...
    def send_packet_like_a_lot(self, packet):
        #print("Sending packet:", packet)  # Debug print
        #print("Destination:", self.slimevr_ip,self.slimevr_port)
        while(True):
    ...
    async def rotate_imu(self, imu_id, rotation, resend):
        if self.slimevr_ip == self.broadcast_ip:
            return "Server not found"
        ...
        self.send_packet(packet, resend)
